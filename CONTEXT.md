...
> Continuity document for resuming work across context windows. Current as of **R56** (2026‑07‑22).
...
- **One change = one `Rxx:` commit** = a resume checkpoint. Current head is **R56**. Continue numbering.
